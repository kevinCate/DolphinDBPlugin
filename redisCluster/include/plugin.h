...
extern "C" ddb::ConstantSP redisClusterClose(ddb::Heap* heap, const std::vector<ddb::ConstantSP>& args);
...
extern "C" ddb::ConstantSP redisClusterBatchHashSetThread(ddb::Heap*, const std::vector<ddb::ConstantSP>& args);
